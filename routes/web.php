...
use App\Http\Controllers\Shopify\AuthCallBackController;
...
Route::get('/api/auth/callback', [AuthCallBackController::class, 'index'])->name('auth-callback');
